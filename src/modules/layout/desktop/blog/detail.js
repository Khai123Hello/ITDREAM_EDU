...
function BlogDetailDesktop({ blog, urlBase, loading }) {
    ...
    const sidebarArticles = [
        {
            id: 201,
            title: 'Làm thế nào để viết CV chuyên nghiệp thu hút nhà tuyển dụng?',
            readTime: '5 phút đọc',
        },
        {
            id: 202,
            title: 'Top câu hỏi phỏng vấn hành vi và cách trả lời STAR',
            readTime: '7 phút đọc',
        },
        {
            id: 203,
            title: 'Học lập trình bắt đầu từ đâu? Lộ trình chuẩn cho người mới',
